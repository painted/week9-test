...
def select_elements_starting_with_a(array)
	# array.sort.take_while do |string|
	# 	string.start_with?('a') 
	# end
	array.delete_if{|string| !string.start_with?('a')}
end

# keep only the elements that start with a vowel
def select_elements_starting_with_vowel(array)
	array.delete_if{|string| !string.start_with?('a', 'e', 'i', 'o', 'u')}
end
